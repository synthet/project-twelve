...
description: Use Gemini CLI through the subagent-orchestrator MCP server for review-only external CLI feedback in ProjectTwelve.
---
...
- Use the `subagent-orchestrator` MCP server (project key **`project-twelve-subagent-orchestrator`**).
