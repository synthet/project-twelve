...
```markdown
## [2026-06-28] ingest | Example topic

Ingested example source. Created example-topic.md under docs/wiki/. Updated docs/wiki/README.md and docs/INDEX.md. Raw source archived under docs/raw/ when applicable.
```
