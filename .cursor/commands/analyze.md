...
- Relevant project rules, package boundaries, Unity `.meta` preservation, paid-assets policy, and security requirements.
...
3. **Constitution findings** — Violations of `AGENTS.md`, `.agent/SAFETY.md`, `docs/PAID_ASSETS.md`, package boundaries, generated-file rules (`.cursor/`, `tools/tile-viz/data/*.json`), or security policy.
