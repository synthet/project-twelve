...
3. **Synthesize an answer** with inline citations linking to source pages under `docs/wiki/` (e.g. `docs/wiki/00-overview.md`).
...
6. If filing:
   - Write the answer as a page under `docs/wiki/` or `docs/reports/` (synthesis/report type) with OKF frontmatter.
...
- PAGE_NAME.md — what this page contributed to the answer
- OTHER_PAGE.md — what this page contributed to the answer
```
