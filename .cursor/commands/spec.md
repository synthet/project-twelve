...
- Problem statement or feature request (from user message, wiki ticket, or linked GitHub issue).
- Constraints: time, scope, tech stack (see **AGENTS.md**).
- Existing principles from `.agent/PROJECT_GUIDE.md`, `AGENTS.md`, `docs/CANONICAL_SOURCES.md`, and project-specific governance docs.
...
Before presenting the spec as approval-ready, run a short clarification pass (or invoke `/clarify`):
