...
**ProjectTwelve test seams:** Unity EditMode tests for C# behavior; `cd tools/tile-viz && npm test` or
`cd tools/world-viz && npm test` for engine-free parity; docs lint for OKF frontmatter changes. See
[`unity-tests`](../unity-tests/SKILL.md).
