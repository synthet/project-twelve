...
- MCP server enabled in [`.cursor/mcp.example.json`](../../../.cursor/mcp.example.json) (copy to gitignored `.cursor/mcp.json`) as **`cli-review`** (or user-level **`subagent-orchestrator`**) and reloaded in Cursor
