...
| — | [Backlog Task Schema & ID Conventions](task-schema.md) | Task ID format, area codes, ticket schema, and the spec→task→commit→verification trace |
