...
This ticket captures the shared product, engineering, QA, and documentation knowledge needed to deliver `P2-GEN-001`. It is intentionally self-contained so the GitHub issue, implementation branch, review notes, and wiki updates can all trace back to the same requirements.
...
As a developer or reviewer working on the P2 milestone, I want to specify biome, cave, structure, and ore generation passes so that the project can advance through the spec-driven workflow with clear scope, objective validation, and durable documentation.

## Requirements

### Functional requirements

1. The implementation or documentation change must satisfy the backlog task: **Specify biome, cave, structure, and ore generation passes.**
...
- Pass order, seed usage, and conflict resolution are deterministic.
...
- Deliver the behavior, documentation, or planning artifact described by `P2-GEN-001`.
...
- Golden-world comparison tests for representative seeds.
