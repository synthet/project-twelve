...
python .claude/skills/verification-before-completion/scripts/harness.py \
  --claim tests_pass --claim assets_synced --claim paid_assets_clean --run --json

# Project self-verify suite
...
- `unity-tests` when the claim is about EditMode/PlayMode results
