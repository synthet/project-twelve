...
| **Project MCP** | `fff-mcp`, Unity MCP, in-game MCP | [`.cursor/mcp.json`](../../../../.cursor/mcp.example.json) copied from template |
...
| **Project-local** | `eslint` in `tools/tile-viz`, `tools/world-viz` | `npm install` in that package |
...
See [AGENTS.md](../../../../AGENTS.md) and the `project-twelve-fff-mcp` entry in [`.cursor/mcp.example.json`](../../../../.cursor/mcp.example.json).
