...
from scripts.skill_harness.verify_catalog import (
...
def test_licensed_path_gate() -> None:
    assert is_licensed_path("Assets/_Licensed/PixelFantasy/foo.png")
    assert is_licensed_path("Assets/PixelFantasy/bar.png")
    assert not is_licensed_path("Assets/_Licensed")  # gitlink allowed
    assert is_blocked_ship_path("Assets/_Licensed/x.png")
    assert not is_blocked_ship_path("README.md")
