...
- User request, linked issue, or wiki ticket under `docs/wiki/tickets/`.
- Project governance from [AGENTS.md](../../AGENTS.md), [SAFETY](../SAFETY.md), [paid-assets](../../.claude/rules/paid-assets.md), and package-specific docs.
