...
- Relevant wiki ticket, GitHub issue, or project-tracking reference, when available.
...
5. List the definition-of-done checks required before `/pr-ready` (including `python3 scripts/check_paid_assets.py --staged` when committing).
